		...
		<div class="overlay-black">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-lg-6 col-md-12 col-sm-12" style="padding: 60px;">

						<!-- breadcrumb-title - start -->
						<div class="breadcrumb-title text-center mb-50">
							<span class="sub-title">our blogs</span>
							<h2 class="big-title">MGM <strong>latest blogs</strong></h2>
						</div>
								...
								<!-- <div class="col-lg-6 col-md-6 col-sm-12">
									<div class="blog-grid-item">
										...
										<div class="blog-content">
											...
											<h4 class="blog-title">MGM personal event</h4>
											<p class="mb-15">
												Lorem Ipsum is simply dummy text of the printing and typesetting industry.
											</p>
											<a href="#!" class="tickets-details-btn">
								...
								<!-- <div class="col-lg-6 col-md-6 col-sm-12">
									<div class="blog-grid-item">
										...
										<div class="blog-content">
											...
											<h4 class="blog-title">Business personal event</h4>
											<p class="mb-15">
												Lorem Ipsum is simply dummy text of the printing and typesetting industry.
											</p>
											<a href="#!" class="tickets-details-btn">
					...
					<div class="spacial-event-wrapper text-center" style="background-image: url(assets/images/spacial-event-bg.jpg);">
						<div class="overlay-black">
							...
							<h2 class="title-large white-color mb-30">
								MGM Events
								<strong class="yellow-color"> All Management</strong>
							</h2>
